...
def _in_progress_samples() -> list[Dict[str, Any]]:
    ...
    samples = [
        ...
        {"sample_id": "SMP-108", "well": "A8", "yield_ng_ul": 17.3, "status": "PASSED", "sample_type": "Blood"},
        ...
        {"sample_id": "SMP-115", "well": "B7", "yield_ng_ul": 18.9, "status": "PASSED", "sample_type": "Tissue"},
        ...
        {"sample_id": "SMP-122", "well": "C6", "yield_ng_ul": 16.4, "status": "PASSED", "sample_type": "Saliva"},
